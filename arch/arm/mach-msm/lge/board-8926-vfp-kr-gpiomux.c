...
static int gpio_reserved_pin_rev_A[] = {
	5, 12, 13, 14, 15, 16, 20, 21, 22, 32, 33, 34, 35, 49, 50, 51, 52, 53, 54,
	56, 65, 66, 67, 75, 76, 77, 78, 79, 81, 82, 83, 84, 85,
	90, 91, 92, 93, 94, 97, 98, 103, 104, 110, 111, 112, 113,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
};
static int gpio_reserved_pin_rev_B[] = {
	5, 12, 13, 14, 15, 16, 20, 21, 22, 32, 33, 34, 35, 49, 50, 51, 52, 53, 54,
	56, 65, 66, 67, 75, 76, 77, 78, 79, 81, 83, 84, 85,
	90, 91, 92, 93, 94, 97, 98, 103, 104, 110, 111, 112, 113,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
};
...
void __init msm8226_init_gpiomux(void)
{
	...
	default:
		for (gpio_index = 0;
		     gpio_reserved_pin_rev_B[gpio_index] < MSM8x26_GPIO_END;
		     gpio_index++) {
			gpio_func_reserved_pin_config.gpio =
			    gpio_reserved_pin_rev_B[gpio_index];
			msm_gpiomux_install(&gpio_func_reserved_pin_config, 1);
		}
		break;
