...
/* F60S JP GPIO Setting */

#define MSM8x26_GPIO_END 121
static int gpio_reserved_pin_rev_zero[] = {
	0, 1, 2, 3, 34, 53, 54, 55, 60, 73, 74, 76, 77, 78, 82, 83, 84, 89, 90, 94, 95, 96, 97, 98, 103, 104, 107, 112, 115, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
};

static int gpio_reserved_pin_rev_A[] = {
	0, 1, 34, 53, 55, 56, 60, 75, 76, 77, 78, 79, 82, 91, 92, 93, 94, 97, 98, 104, 107, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
/*
Rev B gpio 60 for DSV_EN
*/
static int gpio_reserved_pin_rev_B[] = {
	0, 1, 34, 53, 55, 56, 75, 76, 77, 78, 79, 82, 91, 92, 93, 94, 97, 98, 104, 107, 111, 112, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
...
static struct gpiomux_setting atmel_init_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting atmel_init_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config msm_atmel_configs[] __initdata = {
	...
	},
	{
		.gpio = 17,
		.settings = {
			[GPIOMUX_ACTIVE] = &atmel_init_act_cfg,
			[GPIOMUX_SUSPENDED] = &atmel_init_sus_cfg,
		},
	},
	{
		.gpio = 120,
...
static struct msm_gpiomux_config msm_lcd_configs_A[] __initdata = {
	{
...
static struct msm_gpiomux_config msm_lcd_configs_B[] __initdata = {
	{
		.gpio = 23,				/* Initialize LCD_MAKER_ID */
		.settings = {
			[GPIOMUX_ACTIVE]    = &lcd_id_act_cfg,
...
static struct gpiomux_setting wcnss_5wire_wakeup_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv  = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_DOWN,
};
...
static struct msm_gpiomux_config wcnss_5wire_interface[] = {
	...
	},
	{
		.gpio = 56,
		.settings = {
			[GPIOMUX_ACTIVE]    = &wcnss_5wire_wakeup_cfg,
			[GPIOMUX_SUSPENDED] = &wcnss_5wire_suspend_cfg,
		},
	},
};
