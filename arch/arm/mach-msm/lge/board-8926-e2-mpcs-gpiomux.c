...
static struct msm_gpiomux_config msm_i2c_configs[] __initdata = {
	...
	},
	{
		...
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_spi_cs_sus_config,
		},
	},
#endif
#if 0
...
/* TOUCH Pin Setting */
static struct gpiomux_setting touch_int_config[] = {
	{ /* Active */
		.func = GPIOMUX_FUNC_GPIO,
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_UP,
...
static struct gpiomux_setting touch_reset_config[] = {
	{ /* Active */
		.func = GPIOMUX_FUNC_GPIO,
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_NONE,
...
static struct msm_gpiomux_config msm_touch_configs[] __initdata = {
	{
		.gpio = 17,
		.settings = {
			[GPIOMUX_ACTIVE] = &touch_int_config[0],
			[GPIOMUX_SUSPENDED] = &touch_int_config[1],
		},
	},
	{
		.gpio = 16,
...
#ifdef CONFIG_MMC_MSM_SDC3_SDCARD
...
/* WLC Pin Setting */
static struct msm_gpiomux_config gpio_func_wlc_config __initdata = {
	.gpio = 5,			/* Wireless charger EOC alram */
	.settings = {
		[GPIOMUX_SUSPENDED] = &power_control_act_cfg,
		[GPIOMUX_ACTIVE] = &power_control_sus_cfg,
	},
};
